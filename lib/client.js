...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							(0, react_jsx_runtime.jsx)("a", {
								href: GUIDE_BASE_URL + item.type + ".html",
								target: "_blank",
								rel: "noreferrer",
		...
		function OnboardingModal(props) {
			const { onClose, freeModels, configuredStatus, onConfigured, onSniffClipboard, sniffMsg, onDismiss } = props;
						...
						(0, react_jsx_runtime.jsx)("div", {
							...
							children: models.map((m) => {
								...
								return (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										(0, react_jsx_runtime.jsxs)("span", { style: { display: "flex", alignItems: "center", gap: "6px" }, children: [
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								(0, react_jsx_runtime.jsx)("button", {
									...
									children: "📋 我已复制好 API Key 了，自动识别配置"
								}),
		...
		const DEFAULT_HELP = {
			...
			freeModels: [
				...
				},
				{
					...
					title: "OpenRouter 免费模型池（一个 API Key 通吃数十款）",
				...
				},
				{
					...
					keysLabel: "百度千帆控制台获取 API Key ↗",
					keysUrl: "https://console.bce.baidu.com/qianfan/",
					keyPlaceholder: "粘贴你的百度千帆 API Key",
					keyPrefix: "bce-v3/",
									...
									return (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											(0, react_jsx_runtime.jsxs)("div", {
												...
												children: [
													(0, react_jsx_runtime.jsxs)("span", { style: { display: "flex", alignItems: "center", gap: "4px", fontSize: "13px" }, children: [
													...
													isConfigured
														? (0, react_jsx_runtime.jsx)("span", { style: { fontSize: "12px", color: "#2e7d32", fontWeight: 700 }, children: "已接入 ▾" })
														: (0, react_jsx_runtime.jsx)("a", { href: guideUrl, target: "_blank", rel: "noreferrer", style: { fontSize: "12px", color: "#2563eb", fontWeight: 600, textDecoration: "none", cursor: "pointer" }, children: "引导教程 →" })
												]
											}),
								...
								children: [
									(0, react_jsx_runtime.jsx)("button", {
										...
										style: {
											...
											border: "1px solid #d9dde3", background: "#fafbfc", color: "#4b5563",
										...
										children: showManual ? "收起手动配置 ▴" : "🛠 手动配置（粘贴 API Key） ▾"
									}),
