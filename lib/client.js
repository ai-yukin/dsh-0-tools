...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function identifyKeyModel(raw) {
			...
			if (raw.indexOf("bce-v3/") === 0) return "qianfan";
			if (/^[0-9a-f]{32}$/i.test(raw)) return "xinghuo";
			if (/^[a-zA-Z0-9]{20,}$/.test(raw) && raw.length >= 24) return "zai";
			return null;
		}
		...
		function OnboardingModal(props) {
			...
			const guideUrl = (item) => GUIDE_BASE_URL + item.type + ".html";
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								(0, react_jsx_runtime.jsx)("span", {
									style: { display: "inline-block", padding: "2px 10px", borderRadius: "12px", fontSize: "12px", fontWeight: 600, color: configuredCount >= totalCount && totalCount > 0 ? "#2e7d32" : "#6b7280", background: configuredCount >= totalCount && totalCount > 0 ? "#f0fdf4" : "#f2f3f5" },
								...
								return (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										isConfigured
											...
											: (0, react_jsx_runtime.jsx)("a", {
												href: guideUrl(m), target: "_blank", rel: "noreferrer",
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							(0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									"建议配齐以下所有免费模型，免费模型数越多，切换选择更多！"
								]
							}),
							// v1.8.2: 大粘贴框 + 自动识别一键安装（设置页与引导弹窗一致的交互）
							(0, react_jsx_runtime.jsx)("input", {
								type: "text",
								style: {
						...
						children: [
							(0, react_jsx_runtime.jsxs)("div", { style: { display: "flex", flexDirection: "column", gap: "8px" }, children: [
								...
								(0, react_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: "8px" }, children: [
									(0, react_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: () => { if (sniffedKey) installKeyFromInput(sniffedKey); },
