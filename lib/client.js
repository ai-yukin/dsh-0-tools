...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const OR_PLATFORM_URL = "https://openrouter.ai";
		const OR_KEYS_URL = "https://openrouter.ai/keys";
		const OR_MODEL_URL = "https://openrouter.ai/stealth/ox-alpha";
		...
		const DEFAULT_HELP = {
			...
			selected: [
				{ kind: "openrouter", badge: "New", title: "热门免费模型Ox-Alpha一键安装API Key" },
		...
		// Ox-Alpha 一键安装卡：介绍 + 可点链接 + 粘贴 Key + 一键安装（调服务端 /configure-openrouter）。
		function OpenRouterInstallCard(props) {
			const [key, setKey] = _react.useState("");
			const [busy, setBusy] = _react.useState(false);
			const [err, setErr] = _react.useState("");
			const [done, setDone] = _react.useState(false);
			const submit = () => {
				if (!key.trim()) {
					setErr("请先粘贴你的 OpenRouter API Key");
					return;
				}
				setBusy(true);
				setErr("");
				apiFetch("/configure-openrouter", {
					method: "POST",
					headers: { "Content-Type": "application/json" },
					body: JSON.stringify({ key: key.trim() })
				})
			...
			if (done) {
				return (0, react_jsx_runtime.jsx)("div", {
					...
					children: "\u2714 安装成功！Ox-Alpha 已接入并设为默认模型，可在模型列表选择使用。"
				});
			}
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: "Ox-Alpha 是 OpenRouter 平台上当前最热门的免费大模型（匿名预览版）：100 万字符超长上下文、单次最多输出 13.1 万字符、支持文本与图片输入，当前完全免费。"
					}),
					(0, react_jsx_runtime.jsxs)("div", {
						style: { display: "flex", gap: "12px", flexWrap: "wrap" },
						children: [
							(0, react_jsx_runtime.jsx)("a", { href: OR_KEYS_URL, target: "_blank", rel: "noreferrer", style: { color: "#2563eb", fontSize: "12px" }, children: "OpenRouter 获取 Key \u2197" }),
							(0, react_jsx_runtime.jsx)("a", { href: OR_MODEL_URL, target: "_blank", rel: "noreferrer", style: { color: "#2563eb", fontSize: "12px" }, children: "Ox-Alpha 模型页 \u2197" }),
							(0, react_jsx_runtime.jsx)("a", { href: OR_PLATFORM_URL, target: "_blank", rel: "noreferrer", style: { color: "#2563eb", fontSize: "12px" }, children: "OpenRouter 官网 \u2197" })
						]
					}),
					(0, react_jsx_runtime.jsx)("input", {
						type: "password",
						style: INPUT_STYLE,
						placeholder: "粘贴你的 OpenRouter API Key（sk-or- 开头）",
						value: key,
						onChange: (e) => setKey(e.target.value)
					}),
					err ? (0, react_jsx_runtime.jsx)("div", { style: { color: "#e5484d", fontSize: "12px" }, children: err }) : null,
					(0, react_jsx_runtime.jsx)("button", {
						...
						disabled: busy,
						onClick: submit,
						children: busy ? "安装中…" : "一键安装 Ox-Alpha"
					}),
					(0, react_jsx_runtime.jsx)("div", {
						style: { fontSize: "11px", lineHeight: "16px", color: "#9a9fa6" },
						children: "\u26a0 匿名预览模型：官方无硬性截止日期，随时可能转收费、限流或下线；你的输入会被第三方留存，请勿提交敏感信息。"
					})
				]
			});
		}

		// 帮助链接列：普通条目为外链（已读置灰，可带 New 标记），OpenRouter 条目为内嵌一键安装卡。
		function HelpLinkList(props) {
			const [openOr, setOpenOr] = _react.useState(false);
			return (0, react_jsx_runtime.jsx)("div", {
				style: { display: "flex", flexDirection: "column", gap: "8px" },
				children: props.items.map((l) => {
					if (l.kind === "openrouter") {
						return (0, react_jsx_runtime.jsxs)("div", {
							style: { display: "flex", flexDirection: "column", gap: "8px" },
							children: [
								(0, react_jsx_runtime.jsxs)("div", {
									style: { display: "flex", alignItems: "center", cursor: "pointer", color: "#2563eb", fontWeight: 600, fontSize: "13px", userSelect: "none" },
									onClick: () => setOpenOr((v) => !v),
									children: [
										(0, react_jsx_runtime.jsx)("span", {
											children: (openOr ? "\u25be " : "\u25b8 ") + l.title
										}),
										(0, react_jsx_runtime.jsx)(NewBadge, {})
									]
								}),
								openOr ? (0, react_jsx_runtime.jsx)(OpenRouterInstallCard, { onDone: () => props.markRead(l.title) }) : null
							]
						}, "or-" + l.title);
					}
					return (0, react_jsx_runtime.jsxs)("div", {
